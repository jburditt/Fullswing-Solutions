	...
	<div class="col-full">
		...
		<div id="main" class="col-left">
            ...
            <div id="mini-features">
		        <?php
		        	$args = array( 'post_type' => 'infobox', 'order' => 'ASC', 'posts_per_page' => '20' );
            ...
            <?php endwhile; endif; ?>
                ...
                <div class="more-features">
                	<a href="<?php echo get_post_type_archive_link( 'infobox' ); ?>"><span><?php echo $woo_options['woo_main_pages_link_text']; ?></span><img src="<?php echo esc_url( get_template_directory_uri() . '/images/btn-more.png' ); ?>" alt="" /></a>
                </div>
