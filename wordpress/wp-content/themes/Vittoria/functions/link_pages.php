...
function us_wp_link_pages($args = '') {
	...
	$defaults = array(
		'before' => '<p>' . __('Pages:', 'Vittoria'), 'after' => '</p>',
		'link_classes' => 'g-pagination-item', 'next_link_classes' => 'to_next', 'prev_link_classes' => 'to_prev',
		'link_before' => '', 'link_after' => '',
		'next_or_number' => 'number', 'nextpagelink' => __('Next page', 'Vittoria'),
		'previouspagelink' => __('Previous page', 'Vittoria'), 'pagelink' => '%',
		'echo' => 1
	);
...
if(!function_exists('us_pagination')) {
	function us_pagination($pages = 0, $range = 2)
	{
		...
		if(1 != $pages)
		{
			if($paged > 1) $result .= '<a href="'.get_pagenum_link($paged - 1).'" class="g-pagination-item to_prev">'.__('Prev', 'Vittoria').'</a>';
			...
			if ($paged < $pages) $result .= '<a href="'.get_pagenum_link($paged + 1).'" class="g-pagination-item to_next">'.__('Next', 'Vittoria').'</a>';
