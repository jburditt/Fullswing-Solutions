<?php global $smof_data; ?><div class="w-blog imgpos_atleft meta_tagscomments">
	<div class="w-blog-h">
						...
						<a class="w-blog-entry-link" href="<?php the_permalink(); ?>">
							<?php  if ( has_post_thumbnail() ) { ?>
								<span class="w-blog-entry-img">
										<?php the_post_thumbnail('portfolio-list'); ?>
									</span>
							<?php } else { ?>
								<span class="w-blog-entry-img">
										<img src="<?php echo get_template_directory_uri() ?>/img/placeholder/500x500.gif" alt="">
									</span>
							<?php } ?>
