		...
		<div class="w-lang-h">
			<div class="w-lang-list">
				...
				<a class="w-lang-item lang_<?php echo $language['language_code'] ?>" href="<?php echo $language['url'] ?>">
					...
					<span class="w-lang-item-title"><?php echo mb_strtoupper($language['language_code']) ?></span>
				</a>
				<?php } ?>
			</div>
			...
			<span class="w-lang-item">
				<span class="w-lang-item-icon"></span>
				<span class="w-lang-item-title"><?php echo mb_strtoupper($current_language['language_code']) ?></span>
			</span>
			</div>
		</div>
	</div>
