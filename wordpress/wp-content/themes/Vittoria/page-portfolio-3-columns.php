<?php
/*
Template Name: Page: Portfolio 3 Columns
*/
...
$categories_meta = rwmb_meta('vittoria_portfolio_categories', array('taxonomy' => 'us_portfolio_category', 'type' => 'taxonomy'));
$categories_ids = array();

if (count($categories_meta)) {
	foreach($categories as $cat_id => $category)
	{
		if ( ! in_array($category, $categories_meta))
		{
...
if (rwmb_meta('vittoria_portfolio_filter') AND count($categories)) {
			...
			<div class="w-filters-h">
				<div class="w-filters-list">
					<div class="w-filters-item active">
						<a class="w-filters-item-link" href="javascript:void(0);" data-filter="*">All</a>
					</div>
									...
									<div class="w-portfolio-item-image">
										<?php  if ( has_post_thumbnail() ) {
											...
											<div class="w-portfolio-item-meta">
												...
												<span class="w-portfolio-item-text"><?php echo $item_categories_links; ?></span>
											</div>
									</div>
								</a>
							</div>
