...
jQuery(document).ready(function($) {
	var colors = {
		red: {
			primary_color: '#c20',
			link_color: '#c20',
			btn_shadow_color: '#a61c00'
		},
		orange: {
			primary_color: '#f26500',
			link_color: '#f26500',
			btn_shadow_color: '#d94f00'
		},
		brown: {
			primary_color: '#8c5e30',
			link_color: '#9f5811',
			btn_shadow_color: '#734d27'
		},
		grass: {
			primary_color: '#67a300',
			link_color: '#67a300',
			btn_shadow_color: '#578a00'
		},
		green: {
			primary_color: '#098f0d',
			link_color: '#009905',
			btn_shadow_color: '#07780b'
		},
		aqua: {
			primary_color: '#008f7c',
			link_color: '#00a698',
			btn_shadow_color: '#006e5f'
		},
		blue: {
			primary_color: '#008fcc',
			link_color: '#0088cc',
			btn_shadow_color: '#0074a6'
		},
		purple: {
			primary_color: '#992e87',
			link_color: '#a11d8b',
			btn_shadow_color: '#802671'
		},
		pink: {
			primary_color: '#e01b5d',
			link_color: '#e01b5d',
			btn_shadow_color: '#c7104d'
		}
	}
	...
	jQuery('#color_scheme').change(function() {
		switch ($(this).val()){
			case 'Red': update_custom_colors(colors.red); break;
			case 'Orange': update_custom_colors(colors.orange); break;
			case 'Brown': update_custom_colors(colors.brown); break;
			case 'Grass': update_custom_colors(colors.grass); break;
			case 'Green': update_custom_colors(colors.green); break;
			case 'Aqua': update_custom_colors(colors.aqua); break;
			case 'Blue': update_custom_colors(colors.blue); break;
			case 'Purple': update_custom_colors(colors.purple); break;
			case 'Pink': update_custom_colors(colors.pink); break;
		}

	});

	jQuery('#header_show_language').live('click', function(){
		if (jQuery('input[id="header_show_language"]:checked').length > 0) {
	...
	jQuery('#header_show_language').click();
