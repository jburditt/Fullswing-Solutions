	...
	<div id="footer">
    	<div class="col-full">
            ...
            <?php if( get_option( 'woo_footer_right' ) == 'true' ){
                ...
                <p><?php _e( 'Powered by', 'woothemes' ); ?> <a href="http://www.wordpress.org">WordPress</a>. <?php _e( 'Designed by', 'woothemes' ); ?> <a href="<?php $aff = get_option('woo_footer_aff_link'); if(! empty( $aff ) ) { echo esc_url( $aff ); } else { echo esc_url( 'http://www.woothemes.com/' ); } ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/woothemes.png" width="87" height="21" alt="Woo Themes" /></a></p>
            <?php } ?>
            </div>
